...
android {
  namespace = "com.prestondihle.healthtracker"
  compileSdk { version = release(36) { minorApiLevel = 1 } }

  defaultConfig {
    applicationId = "com.prestondihle.healthtracker"
    // Health Connect requires API 26+; the client library gates its own availability check.
    minSdk = 26
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
